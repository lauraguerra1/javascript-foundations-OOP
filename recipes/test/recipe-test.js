...
describe('Recipe', function() {
  ...
  it('should be able to generate a grocery list with proper grammar', function () {
    var chicken = new Ingredient({ name: 'rotisserie chicken', amount: 1 });
    var carrots = new Ingredient({ name: 'carrots', amount: 3 });
    var celery = new Ingredient({ name: 'celery', amount: 2 });
    var onion = new Ingredient({ name: 'yellow onion', amount: 1 });
    ...
    var groceryList = soup.grammarGroceryList();

    assert.equal(groceryList, 'You need: 1 rotisserie chicken, 3 carrots, 2 celery, 1 yellow onion, 4 chicken broth, and 1 egg noodles.');
  });
