...
describe('Dragon', function() {
  ...
  it('resets the amount of times it has eaten after eating 3 times', function() {
    var dragon = new Dragon('Brucifer');

    dragon.eat(); 
    dragon.eat(); 
    dragon.eat(); 
    dragon.eat(); 
    assert.equal(dragon.timesAte, 1)
  })

  it('is hungry again after flying, even if he has already ate 3 times', function() {
    var dragon = new Dragon('Jackson The Bone Slayer');
